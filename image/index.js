$(function () {
            ...
            success: function (data) {
                ...
                $li.hover(
                    function () {
                        ...
                        $(this).stop().animate({ "margin-top": "4px", "margin-bottom": "3px" }, 10)
                    }, function () {
                        $(this).css("box-shadow", "0 0 0 #999999, 0 0 0 #999999");
                        $(this).stop().animate({ "margin-top": "7px", "margin-bottom": "0px" }, 10)
                    }
                )
                ljz();
            }
            ...
            success: function (data) {
                ...
                $li.hover(
                    function () {
                        console.log($(this))
                        $(this).css("box-shadow", "1px 5px 16px #999999, 0px 5px 16px #999999");
                        $(this).stop().animate({ "margin-top": "3px", "margin-bottom": "4px" }, 10)
                    }, function () {
                        $(this).css("box-shadow", "0 0 0 #999999, 0 0 0 #999999");
                        $(this).stop().animate({ "margin-top": "7px", "margin-bottom": "0px" }, 10)
                    }
    ...
    // 北京出发下拉框
    $(".gotoBj-btn").click(function (event) {
        $(".content1-head-wrap").toggle();
        event.stopPropagation();
    });
    $(document).click(function () {
        $(".content1-head-wrap").stop().hide();
    });
    $(".content1-closeBtn").click(function () {
        $(".content1-head-wrap").hide();
    })
